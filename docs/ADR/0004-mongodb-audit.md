...
## Decision
Use MongoDB for audit events and metadata; migrate to MongoDB Atlas for a TLS ingress demo.
## Consequences
...
Mitigations: `.env` ignored, `.env.example` placeholders, planned API RBAC (not implemented), security scanning.
